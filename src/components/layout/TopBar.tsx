...
export default function TopBar() {
  return (
    <div className="hidden border-b border-[var(--border)] bg-[var(--secondary)] text-white/80 lg:block">
      <Container className="flex items-center justify-between py-2 text-xs">
        ...
        <div className="flex items-center gap-4">
          ...
          <a
            href={getPhoneUrl()}
            className="ml-2 font-semibold text-[var(--primary)] transition-colors hover:text-white"
